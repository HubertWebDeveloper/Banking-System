...
<body style="background-image: url('images/blueriverlogo.png'); background-size: contain; background-position: center; background-repeat: no-repeat; margin: 0; padding: 0;">
<?php
