...
<?php
    $admins = mysqli_query($con, "SELECT * FROM `assets` WHERE `usePIN`= '$userPIN' AND `asset_type`='debit' ORDER BY id DESC");
    $tranctions = mysqli_query($con, "SELECT * FROM `transactions`");
    $i=0;
?>
<div class="card-header">
    <button class="btn" style="background:#1f3864;color:white" data-bs-toggle="modal" data-bs-target="#addBudget">Add New Debit</button>
</div>
<form action="EditCode.php" method="POST" class="bg-white"style="padding:10px">
    <div class="buttons text-end">
       <button type="submit" name="editDebit" class="mb-2" id="editButton"style="border:none;background:#424949;color:white;padding:5px 7px;border-radius:4px"><i class="mdi mdi-marker"></i></button>
       <button type="submit" name="deleteDebit" class="mb-2" id="deleteButton"style="border:none;background:#DE3163;color:white;padding:5px 7px;border-radius:4px"><i class="mdi mdi-window-close"></i></button>
    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Adding New Debit</h1>
                ...
                <div class="container-fluid px-4 mb-4">
                    <form action="EditCode.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="saveDebit" class="btn" style="background:#1f3864;color:white">Save Data</button>
                        </div>
                    </form>
                </div>
            </div>
